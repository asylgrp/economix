...
task('examples', ['descparser/src/Grammar.php'], function() {
    sh('readme-tester accounting2matchable/README.md descparser/README.md receiptanalyzer/README.md matchmaker/README.md', null, ['failOnError' => true]);
    println('Documentation examples valid');
});

desc('Run statical analysis using phpstan');
task('phpstan', function() {
    sh('phpstan analyze -c phpstan.neon -l 7 descparser/src receiptanalyzer/src matchmaker/src accounting2matchable/src', null, ['failOnError' => true]);
