...
class ActiveContactPersonSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType(ActiveContactPerson::CLASS);
    }
    ...
    function it_can_create_with_mail($account)
    {
        ...
        $this->withMail('foobar')->shouldBeLike(
            new ActiveContactPerson('id', 'name', $account->getWrappedObject(), 'foobar', 'phone', 'comment')
        );
    }
    ...
    function it_can_create_with_phone($account)
    {
        ...
        $this->withPhone('foobar')->shouldBeLike(
            new ActiveContactPerson('id', 'name', $account->getWrappedObject(), 'mail', 'foobar', 'comment')
        );
    }
    ...
    function it_can_create_with_comment($account)
    {
        ...
        $this->withComment('foobar')->shouldBeLike(
            new ActiveContactPerson('id', 'name', $account->getWrappedObject(), 'mail', 'phone', 'foobar')
        );
    }
